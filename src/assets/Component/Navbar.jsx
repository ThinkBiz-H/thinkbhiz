...
const Navbar = () => {
    ...
    <nav className="bg-white text-black px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 font-semibold text-orange-400 relative">
          ...
          >
            Services
            <ul className="absolute left-0 top-8 bg-white text-black shadow-xl rounded-xl p-4 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition z-50">
              {[
  ...
  className="w-full py-2 flex items-center justify-center gap-2 text-orange-400 font-semibold"
>
  Services
  <ChevronDown
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    onClick={closeMobileMenu} // ✅ menu close
    className="
      flex items-center gap-2
      bg-[#ff7515]
      text-white
